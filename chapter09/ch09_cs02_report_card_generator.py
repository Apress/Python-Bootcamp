...
def calculate_grade(a1_score, a2_score, e_score):
    """
    This function calculates the final score.
    Here is the consideration:
    25% of the total marks in assignments and
    75% of the total marks make the grade card.
    """
    final_score = (a1_score + a2_score) * .25 + e_score * .75
    return final_score
...
def save_scores(name,assign1,assign2,exam,score,grade):
    """
    ...
    try:
        ...
        new_path = os.path.join(current_path, relative_path)
...
def main():
    """
    It is the top-level function for this application.
    """
    ...
    try:
        ...
        save_scores(student_name,assign1,assign2,exam,final_score,grade_score)
